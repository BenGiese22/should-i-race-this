...
export type GoalMode = 'balanced' | 'push' | 'recovery';
...
export function GoalModeSelector({ currentMode, onModeChange, disabled = false, isProUser = false }: GoalModeSelectorProps) {
