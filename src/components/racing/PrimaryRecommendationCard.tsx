...
import { Clock, Calendar, ChevronDown, ChevronUp, Gauge } from 'lucide-react';
            ...
            <div className="flex items-center gap-8">
              ...
              <div>
                ...
                <div 
                  ...
                  style={{ 
                    color: (recommendation.avgPositionDelta ?? 0) > 0 
                      ? 'var(--semantic-positive)' 
                      : (recommendation.avgPositionDelta ?? 0) < 0
                      ? 'var(--semantic-caution)'
                      : 'var(--text-primary)' 
                  }}
                >
                  {(recommendation.avgPositionDelta ?? 0) > 0 ? '+' : ''}{(recommendation.avgPositionDelta ?? 0).toFixed(1)}
                </div>
              ...
              <div>
                ...
                <div 
                  className="text-2xl font-bold stat-number"
                  style={{ 
                    color: (recommendation.avgIncidents ?? 0) < 2 
                      ? 'var(--semantic-positive)' 
                      : (recommendation.avgIncidents ?? 0) < 4 
                      ? 'var(--semantic-caution)' 
                      : 'var(--semantic-danger)' 
                  }}
                >
                  {(recommendation.avgIncidents ?? 0).toFixed(1)}x
                </div>
                <div className="text-xs text-[var(--text-tertiary)] mt-0.5">avg per race</div>
              </div>
            </div>
