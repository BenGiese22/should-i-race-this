              ...
              <div className="bg-[var(--bg-surface)] border border-[var(--border-medium)] rounded-xl p-8">
                <div className="flex items-start justify-between mb-6">
                  <div>
                    ...
                    <h3 className="mb-2">Advanced Mazda MX-5 Cup</h3>
                ...
                <div className="grid grid-cols-3 gap-6 mb-6">
                  <div>
                    ...
                    <div className="text-[var(--text-primary)] font-semibold">6:00 PM EST</div>
                  </div>
                  <div>
                    <div className="text-xs text-[var(--text-tertiary)] uppercase tracking-wide mb-1">Length</div>
                    <div className="text-[var(--text-primary)] font-semibold">25 minutes</div>
                  </div>
                  <div>
                    <div className="text-xs text-[var(--text-tertiary)] uppercase tracking-wide mb-1">Confidence</div>
                    <div className="text-[var(--accent-primary)] font-semibold stat-number">92%</div>
                  </div>
                </div>
